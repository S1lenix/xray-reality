...
curl -s https://raw.githubusercontent.com/S1lenix/xray-reality/master/default.json > config.json
...
json=$(curl -s https://raw.githubusercontent.com/S1lenix/xray-reality/master/config.json)
